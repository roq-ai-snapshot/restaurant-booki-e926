...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  ...
  'menu.update': { roles: ['owner', 'waiter'], key: 'dish-updated', tenantPath: ['restaurant', 'menu'], userPath: [] },
  'menu.delete': { roles: ['owner', 'waiter'], key: 'dish-removed', tenantPath: ['restaurant', 'menu'], userPath: [] },
  'reservation.create': {
    roles: ['owner', 'waiter'],
    key: 'new-reservation',
