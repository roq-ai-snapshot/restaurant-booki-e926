  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Restaurant Booking Engine - Streamlining Your Dining Experience. Reserve, Manage, and Savor the Ease of Our Comprehensive Restaurant Management Solution."
        />
      </Head>
      <HomeLayout>
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Restaurant Booking Engine - Streamlining Your Dining Experience. Reserve, Manage, and Savor the Ease of Our Comprehensive Restaurant Management Solution.`}
            </Text>
            <Box
